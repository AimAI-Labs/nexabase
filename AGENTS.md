...
## 4. 架构与编码核心规范 (Development Guidelines)
...
### 4.2 配置管理规范 (Configuration Management)
...
## 5. AI 行为与交互准则 (AI Agent Behaviors)
